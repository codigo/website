...
ARG SECRET_POCKETBASE_ADMIN_EMAIL
ARG SECRET_POCKETBASE_ADMIN_PASSWORD
...
ENV SECRET_POCKETBASE_ADMIN_EMAIL=$SECRET_POCKETBASE_ADMIN_EMAIL
ENV SECRET_POCKETBASE_ADMIN_PASSWORD=$SECRET_POCKETBASE_ADMIN_PASSWORD
# Build the app
RUN npm run build
